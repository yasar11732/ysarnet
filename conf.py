...
sys.path.append("themes/myreadable/messages")
...
BLOG_DESCRIPTION = 'Yaşar Arabacı\'nın blogunda, Python\'un nedir, ne işe yarar anlatılır. Python programlama hakkında Türkçe dersler ve örnek kodlar bulunur.'
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ('/index.html', 'Anasayfa', 'icon-home'),
        ('/arsiv/', 'Arşiv', 'icon-folder-open-alt'),
        ('/tags/index.html', 'Tags', 'icon-tags'),
        ('/rss.xml', 'RSS', 'icon-rss'),
        ('yasar-arabaci', 'About me', 'icon-user'),
        ('https://twitter.com/y_arabaci', 'My Twitter', 'icon-twitter'),
        ('https://github.com/yasar11732', 'My Github', 'icon-github'),
    )
}
"""
...
MARKDOWN_EXTENSIONS = ['fenced_code', 'codehilite','abbr','tables',"extra"]

#  buttons. This is sample code for AddThis (which was the default for a
...
window.___gcfg = {
  ...
  ga('create', 'UA-44774134-1', 'ysar.net');
  ga('send', 'pageview');
...
# ADDITIONAL_METADATA = {"author":"Yaşar Arabacı","authorprofile":"/yasar-arabaci.html"}
...
TWITTER_CARD = {
     ...
     # 'site:id': 123456,  # Same as site, but the website's Twitter user ID
                           # instead.
      'creator': '@y_arabaci',  # Username for the content creator / author.
...
GLOBAL_CONTEXT = {"author":"Yaşar Arabacı","authorprofile":"/yasar-arabaci.html"}